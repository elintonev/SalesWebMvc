...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        //        return; // Esse IF serve para verificar se já possuem os dados a serem adicionados no Banco de Dados.
        //    }
        ...
        //    _context.Department.AddRange(d1, d2, d3, d4); //Adicionar dados ao banco de dados
